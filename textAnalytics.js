...
function analyze(){
  var reqBody = {
    ...
    var myHeader =  new Headers({
      ...
      'Ocp-Apim-Subscription-Key':'9f09d10a8fde4fd0a3dda7ecdc5a625e'
  });
    ...
    var request =
    new Request("https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/keyPhrases",initObject);
